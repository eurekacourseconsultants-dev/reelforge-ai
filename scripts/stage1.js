...
- scenes: exactly 6 items, each a vivid 5-second visual description
- For avatar_scene: each scene description should mention the avatar/person naturally (e.g. "a woman walks through...")
- For avatar_lipsync: scenes describe what appears behind/around the speaking avatar
- For scene: purely visual, no speaking person required`
      }],
      max_tokens: 1000,
    })
  })
